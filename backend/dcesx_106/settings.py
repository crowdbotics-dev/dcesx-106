"""
Django settings for dcesx_106 project.
...
WSGI_APPLICATION = 'dcesx_106.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dcesx_106 API",
    "DESCRIPTION": "API documentation for dcesx_106 App",
    "VERSION": "v1",
}
